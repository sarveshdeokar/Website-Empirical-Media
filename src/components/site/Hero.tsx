  ...
  return (
    <section className="relative min-h-screen flex items-center pt-32 pb-20 overflow-hidden noise">
      ...
      <div className="relative mx-auto max-w-7xl px-6 w-full">
        ...
        <h1 className="font-display sm:text-5xl lg:text-[6.5rem] font-bold leading-[0.95] tracking-tighter text-2xl">
          <span className="text-gradient">From Television</span>
          <br />
        ...
        <div className="mt-10 grid md:grid-cols-2 gap-10 items-end">
          <div className="max-w-xl space-y-4">
            ...
            <p className="italic text-foreground/80 whitespace-nowrap">Empirical Media makes every impression count.</p>
          </div>
